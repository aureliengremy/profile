    ...
    return (
        <div className={`section-description ${addClass}`}>
            ...
            <div className="text-gray-600">
                <p className="py-2">Je suis Aurélien Gremy, patient et déterminé, j'ai toujours tout fait pour créer la meilleur des synergie entre ces deux qualités, sportif dans une constante optimisation des mes objectifs, musicien entretenant sa soif de créativité dans une recherche constante de nouveautés.</p>
